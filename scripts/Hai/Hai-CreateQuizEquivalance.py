...
data_path = "Hai.xlsx"
rows = XLUtils.getRowCount(data_path, "CreateQuizEquivalence")

for row in range(2, rows + 1):
    name = XLUtils.readData(data_path, "CreateQuizEquivalence", row, 1)
    time_limit = XLUtils.readData(data_path, "CreateQuizEquivalence", row, 2)
