...
class TestInvalidusername():
  ...
  def test_invalidusername(self):
    ...
    self.driver.find_element(By.ID, "id_username").send_keys("siuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuu!@$!@$!@$")
